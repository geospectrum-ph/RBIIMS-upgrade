  ...
  const LAYER_GROUPS = [
    {
      ...
      layers: [
        ...
        { id: "boundary-municipal", label: "Municipal Boundaries" },
        { id: "boundary-barangay", label: "Barangay Boundaries" },
      ...
      subGroups: [
        {
          ...
          layers: ["boundary-municipal", "boundary-provincial", , "boundary-barangay"],
        },
        {
        ...
        },
        {
          ...
          layers: [
            "Abatan_stream_Network",
            "Abra_stream_Network",
            "Abulug_stream_Network",
            "Agno_stream_Network",
            "Agus_stream_Network",
            "Agusan_stream_Network",
            "Aklan_stream_Network",
            "Amburayan_stream_Network",
            "Amnay_stream_Network",
            "Angat_stream_Network",
            "Aringay_stream_Network",
            "Asiga_stream_Network",
            "Bago_stream_Network",
            "Balite_stream_Network",
            "Basey_stream_Network",
            "Bato_stream_Network",
            "Bauang_stream_Network",
            "Bayawan_stream_Network",
            "Bicol_stream_Network",
            "Binalbagan_stream_Network",
            "Bislak_stream_Network",
            "Bislig_stream_Network",
            "Bongabong_stream_Network",
            "Bucao_stream_Network",
            "Cadacan_stream_Network",
            "Cagaranan_stream_Network",
            "Cagayan_stream_Network",
            "Cagayan_de_Oro_stream_Network",
            "Caguray_stream_Network",
            "Calbiga_stream_Network",
            "Calumpang_stream_Network",
            "Cantilan_stream_Network",
            "Caraga_stream_Network",
            "Casauman_stream_Network",
            "Catarman_stream_Network",
            "Cateel_stream_Network",
            "Catubig_stream_Network",
            "Daguitan_Marabang_stream_Network",
            "Davao_stream_Network",
            "Dikayu_stream_Network",
            "Dinas_stream_Network",
            "Dipolog_stream_Network",
            "Diteki_stream_Network",
            "Dolores_stream_Network",
            "Gandara_stream_Network",
            "Glan_stream_Network",
            "Himogaan_stream_Network",
            "Hinatuan_stream_Network",
            "Ilian_stream_Network",
            "Ilog_Hilabangan_stream_Network",
            "Inabanga_stream_Network",
            "Infanta_stream_Network",
            "Ingin_Maras_stream_Network",
            "Iponan_stream_Network",
            "Jalaur_stream_Network",
            "Jibatang_stream_Network",
            "Kalaong_stream_Network",
            "Kilbay_Catabangan_stream_Network",
            "Kraan_stream_Network",
            "Labangan_stream_Network",
            "Labo_stream_Network",
            "Laoag_stream_Network",
            "Lasang_stream_Network",
            "Little_Lun_stream_Network",
            "Llorente_stream_Network",
            "Loboc_stream_Network",
            "Lubao_stream_Network",
            "Lumangbayan_stream_Network",
            "Lumintao_stream_Network",
            "Magasawang_Tubig_stream_Network",
            "Magbando_stream_Network",
            "Makar_stream_Network",
            "Malaking_Ilog_stream_Network",
            "Malaylay_stream_Network",
            "Malungon_stream_Network",
            "Mamburao_stream_Network",
            "Mandulog_stream_Network",
            "Mano_stream_Network",
            "Maranding_stream_Network",
            "Marikina_Pasig_stream_Network",
            "Matling_stream_Network",
            "Mongpong_stream_Network",
            "Norte_Lauis_stream_Network",
            "Odiongan_stream_Network",
            "Ogod_stream_Network",
            "Oras_stream_Network",
            "Padala_Mainit_stream_Network",
            "Pagatban_stream_Network",
            "Pagbahan_stream_Network",
            "Pagsangahan_stream_Network",
            "Palanan_stream_Network",
            "Palo_stream_Network",
            "Pambu_Khan_stream_Network",
            "Pampanga_stream_Network",
            "Pamplona_stream_Network",
            "Panay_stream_Network",
            "Pansipit_stream_Network",
            "Paro_Dapitan_stream_Network",
            "Patalan_Dagupan_stream_Network",
            "Quipit_stream_Network",
            "Rio_Grande_de_Mindanao_stream_Network",
            "Rizal_stream_Network",
            "Roxas_stream_Network",
            "Sablayan_stream_Network",
            "Salug_stream_Network",
            "Sangputan_stream_Network",
            "Sibalom_stream_Network",
            "Sibuguey_stream_Network",
            "Sibulao_stream_Network",
            "Siguel_stream_Network",
            "Silay_stream_Network",
            "Sindangan_stream_Network",
            "Siocon_stream_Network",
            "Sipalay_stream_Network",
            "Sipocong_stream_Network",
            "Sumlog_stream_Network",
            "Suribao_stream_Network",
            "Taboan_stream_Network",
            "Taft_stream_Network",
            "Tago_stream_Network",
            "Tagoloan_stream_Network",
            "Tagum_stream_Network",
            "Tanjay_stream_Network",
            "Ternate_stream_Network",
            "Tian_stream_Network",
            "Tigum_stream_Network",
            "Ulot_stream_Network",
            "Umiray_stream_Network",
          ],
        },
        {
    ...
    {
      title: "Raster Layers",
      layers: [{ id: "srtm-dem", label: "Digital Elevation Model" }],
    },
  ];
